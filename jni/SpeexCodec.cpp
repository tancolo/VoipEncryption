#include "com_android_cktencryptvoip_codec_SpeexCodec.h"
...
JNIEXPORT jint JNICALL Java_com_android_cktencryptvoip_codec_SpeexCodec_openSpeex (JNIEnv *env, jobject obj){
...
JNIEXPORT void JNICALL Java_com_android_cktencryptvoip_codec_SpeexCodec_closeSpeex (JNIEnv *env, jobject obj ){
  if( !initialized ) {
...
JNIEXPORT jint JNICALL Java_com_android_cktencryptvoip_codec_SpeexCodec_decode (JNIEnv *env, jobject obj, jbyteArray encArr, jshortArray decArr, jint encLen ){
  cenv = env;
  if( !initialized ) {
...
JNIEXPORT jint JNICALL Java_com_android_cktencryptvoip_codec_SpeexCodec_encode (JNIEnv *env, jobject obj, jshortArray decArr, jbyteArray encArr, jint rawLen ){
  if( !initialized ) {
